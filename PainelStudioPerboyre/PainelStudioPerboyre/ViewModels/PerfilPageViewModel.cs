...
namespace PainelStudioPerboyre.ViewModels
{
	public class PerfilPageViewModel : ViewModelBase
    {
        ...
        private Dentista _dentista  =null;
        ...
        private async void abrircamera()
        {
           ...
           // var action = await _dialogService.DisplayActionSheetAsync("" , "Cancel", null, "Tirar nova foto", "Galeria");
            ...
            {
                await PageDialogService.DisplayAlertAsync("Painel Studio - Perboyre", "Sua Camera não esta Disponivel", "Ok");
        ...
        private async void selecionargaleria()
        {
            ...
            {
                await PageDialogService.DisplayAlertAsync("Painel Studio - Perboyre", "Arquivo não Suportado", "Ok");
